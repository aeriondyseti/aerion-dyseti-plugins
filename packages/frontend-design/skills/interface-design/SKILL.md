...
Read `.frontend-design/system.md` and apply. Decisions are made.
...
If yes, write to `.frontend-design/system.md`:
- Direction and feel
...
- `references/system-template.md` — Template for `.frontend-design/system.md` with visual language spec

# Commands

- `/design:status` — Current design system state
- `/design:audit` — Check code against design system + web interface guidelines
- `/design:extract` — Extract patterns from existing code into system.md
